...
//   3. NEVER cache HTML/navigation responses (they're tenant-specific and, if
//      cached, reintroduce the "users can't see their changes" staleness bug).
//      Navigations are network-first; the ONLY thing served from cache on a
//      failed navigation is the generic /offline.html.
...
// Network-first for navigations: always try fresh HTML; on failure show the
// generic offline page. We NEVER cache the navigation response itself.
