// NemPOS adapter — STUB. Implements the PosAdapter contract so the registry,
...
const NOT_IMPLEMENTED = "NemPOS non implementato (in attesa di credenziali API)";

export const nemposAdapter: PosAdapter = {
  provider: "nempos",
