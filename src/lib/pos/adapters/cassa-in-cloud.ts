// Cassa in Cloud adapter — STUB. Implements the PosAdapter contract so the registry,
...
const NOT_IMPLEMENTED = "Cassa in Cloud non implementato (in attesa di credenziali API)";
