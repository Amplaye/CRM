...
export const PILOT_I18N: Record<PilotLang, PilotStrings> = {
  es: {
    ...
    termsLabel: "Términos del piloto", businessNameLabel: "Nombre del negocio",
  ...
  en: {
    ...
    termsLabel: "pilot terms", businessNameLabel: "Business name",
  ...
  it: {
    ...
    termsLabel: "Termini del pilota", businessNameLabel: "Nome dell'attività",
  ...
  de: {
    ...
    termsLabel: "Pilot-Bedingungen", businessNameLabel: "Name des Unternehmens",
