...
export default function AdminPage() {
  ...
  if (globalRole !== "platform_admin") {
     return (
        <div className="p-8 max-w-7xl mx-auto flex justify-center mt-20 text-zinc-500 text-center">
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">{t("admin_subtitle")}</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <div className="bg-white p-6 rounded-xl shadow-sm border border-zinc-200">
            <h3 className="font-semibold text-zinc-500 text-sm">{t("admin_total_tenants")}</h3>
            <p className="text-3xl font-bold mt-2">12</p>
         </div>
         <div className="bg-white p-6 rounded-xl shadow-sm border border-zinc-200">
            <h3 className="font-semibold text-zinc-500 text-sm">{t("admin_conv_processed")}</h3>
            <p className="text-3xl font-bold mt-2 text-indigo-600">4,209</p>
         </div>
         <div className="bg-white p-6 rounded-xl shadow-sm border border-zinc-200">
            <h3 className="font-semibold text-zinc-500 text-sm">{t("admin_health")}</h3>
         ...
         <table className="min-w-full divide-y divide-zinc-200">
            <tbody className="divide-y divide-zinc-100 text-sm">
               <tr className="hover:bg-zinc-50">
                  ...
                  <td className="px-6 py-4 text-zinc-500">{t("admin_since_oct")}</td>
               ...
               <tr className="hover:bg-zinc-50">
                  ...
                  <td className="px-6 py-4 text-zinc-500">{t("admin_since_dec")}</td>
                  <td className="px-6 py-4"><span className="px-2 py-0.5 bg-emerald-100 text-emerald-800 rounded text-xs font-medium">{t("admin_healthy")}</span></td>
                  <td className="px-6 py-4 text-right text-indigo-600 font-medium cursor-pointer">{t("admin_impersonate")}</td>
               </tr>
            </tbody>
