      ...
      <div className={`flex-1 transition-all duration-300 ${(selectedRes || isCreating) ? 'pr-[400px]' : ''}`}>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500">{t("res_subtitle")}</p>
          </div>
        ...
        <div className="bg-white p-4 flex flex-col sm:flex-row items-center justify-between border-b border-zinc-200 rounded-t-xl hidden md:flex border-x border-t">
           ...
           <button className="flex items-center text-sm font-medium text-zinc-600 hover:text-zinc-900 px-3 py-1.5 border border-transparent hover:bg-zinc-50 rounded-md transition-colors">
      ...
      {selectedRes && (
        <div className="fixed inset-y-0 right-0 w-[400px] bg-white border-l border-zinc-200 shadow-2xl z-40 transform transition-transform duration-300 flex flex-col pt-16">
          <div className="px-6 py-4 flex items-center justify-between border-b border-zinc-100">
             ...
             <button onClick={() => setSelectedRes(null)} className="p-2 text-zinc-400 hover:bg-zinc-100 hover:text-zinc-600 rounded-full transition-colors">
                <X className="h-5 w-5" />
             </button>
          </div>
             ...
             <div className="flex-1 overflow-y-auto w-full p-6 space-y-6 bg-zinc-50/50">
                ...
                <div className="grid grid-cols-2 gap-4">
                   <div>
                     ...
                     <input name="date" type="date" defaultValue={selectedRes.date} className="w-full border border-zinc-200 bg-white rounded-lg px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-zinc-900" />
                   </div>
                   <div>
                     <label className="block text-sm font-medium text-zinc-700 mb-1">{t("res_edit_time")}</label>
      ...
      {isCreating && (
        <div className="fixed inset-y-0 right-0 w-[400px] bg-white border-l border-zinc-200 shadow-2xl z-40 transform transition-transform duration-300 flex flex-col pt-16">
          <div className="px-6 py-4 flex items-center justify-between border-b border-zinc-100">
             ...
             <button onClick={() => setIsCreating(false)} className="p-2 text-zinc-400 hover:bg-zinc-100 hover:text-zinc-600 rounded-full transition-colors">
                <X className="h-5 w-5" />
             </button>
          </div>
          <form onSubmit={handleCreate} className="flex-1 flex flex-col">
             <div className="flex-1 overflow-y-auto p-6 space-y-5 bg-zinc-50/50">
                ...
                <div>
                   ...
                   <input required name="guestName" type="text" placeholder="John Doe" className="w-full border border-zinc-200 bg-white rounded-lg px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-zinc-900" />
                </div>
                <div>
                   <label className="block text-sm font-medium text-zinc-700 mb-1">Guest Phone</label>
                   <input required name="guestPhone" type="tel" placeholder="+1 555-0192" className="w-full border border-zinc-200 bg-white rounded-lg px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-zinc-900" />
                </div>

                <div className="grid grid-cols-2 gap-4 pt-2">
                   <div>
                     <label className="block text-sm font-medium text-zinc-700 mb-1">Date</label>
                     <input required name="date" type="date" defaultValue={date} className="w-full border border-zinc-200 bg-white rounded-lg px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-zinc-900" />
                   </div>
                   <div>
                     <label className="block text-sm font-medium text-zinc-700 mb-1">Time</label>
                     <input required name="time" type="time" defaultValue="19:00" className="w-full border border-zinc-200 bg-white rounded-lg px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-zinc-900" />
                   </div>
                </div>

                <div>
                   <label className="block text-sm font-medium text-zinc-700 mb-1">Party Size</label>
                   <input required name="partySize" type="number" min="1" max="20" defaultValue="2" className="w-full border border-zinc-200 bg-white rounded-lg px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-zinc-900" />
                </div>
