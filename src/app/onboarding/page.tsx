...
// Four steps: profile → hours → questionnaire → summary. The POS/till choice
// that used to live here was removed because connecting a cash register is now a
// paid add-on (smart_inventory / management module): the owner enables it from
// Settings → Payments after onboarding, not during the free setup.
type Step = 1 | 2 | 3 | 4;
