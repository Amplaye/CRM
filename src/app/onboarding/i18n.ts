...
interface Q4Strings {
  ...
  largeGroups: string; deposit: string; depositAmount: string; depositAmountPlaceholder: string; lateTolerance: string; lateGrace: string;
...
export const UI: Record<UiLang, UiStrings> = {
  es: {
    ...
    q4: {
      ...
      depositAmount: "Importe del depósito", depositAmountPlaceholder: "20€ por persona / 50€ por mesa",
      lateTolerance: "Tolerancia de retraso", lateGrace: "¿Más margen si el cliente avisa con antelación?",
      cancellationNotice: "¿Con cuánta antelación debe avisar el cliente para cancelar?", noShowRelease: "Liberar mesa por no-show tras",
      lastLunch: "Última reserva (comida)", lastDinner: "Última reserva (cena)",
      cxNone: "No hace falta avisar", cxSameDay: "El mismo día vale", cx2h: "Al menos 2 h antes", cx24h: "Al menos 24 h antes",
      ...
      info: {
        ...
        lateTolerance: "Cuántos minutos guardáis la mesa a un cliente que LLEGA tarde antes de poder dársela a otro. Ej.: 15 min → si reserva a las 21:00 y no llega, a las 21:15 pasa a no-show. Esto vale para quien NO avisa. Si el cliente avisa del retraso, el bot mueve la hora de la reserva en consecuencia (p. ej. 21:30 + 30 min → 22:00).",
        ...
        noShowRelease: "Distinto de la tolerancia de retraso: aquí el cliente NO aparece y NO avisa. Cuánto esperáis antes de liberar la mesa y darla a otro. Si no lo especificas, el asistente no inventa un tiempo.",
  ...
  it: {
    ...
    q4: {
      ...
      depositAmount: "Importo della caparra", depositAmountPlaceholder: "20€ a persona / 50€ a tavolo",
      lateTolerance: "Tolleranza ritardo", lateGrace: "Più margine se il cliente avvisa in anticipo?",
      cancellationNotice: "Con quanto anticipo il cliente deve avvisare per cancellare?", noShowRelease: "Libera il tavolo per no-show dopo",
      lastLunch: "Ultima prenotazione (pranzo)", lastDinner: "Ultima prenotazione (cena)",
      cxNone: "Non serve avvisare", cxSameDay: "In giornata va bene", cx2h: "Almeno 2 h prima", cx24h: "Almeno 24 h prima",
      ...
      info: {
        ...
        lateTolerance: "Quanti minuti tenete il tavolo a un cliente che ARRIVA in ritardo prima di poterlo dare a qualcun altro. Es.: 15 min → se prenota alle 21:00 e non arriva, alle 21:15 diventa un no-show. Vale per chi NON avvisa. Se invece il cliente avvisa del ritardo, il bot sposta l'orario della prenotazione di conseguenza (es. 21:30 + 30 min → 22:00).",
        ...
        noShowRelease: "Diverso dalla tolleranza ritardo: qui il cliente NON si presenta e NON avvisa. Quanto aspettate prima di liberare il tavolo e darlo ad altri. Se non lo specifichi, l'assistente non inventa un tempo.",
  ...
  en: {
    ...
    q4: {
      ...
      depositAmount: "Deposit amount", depositAmountPlaceholder: "€20 per person / €50 per table",
      lateTolerance: "Late arrival tolerance", lateGrace: "More leeway if the guest lets you know in advance?",
      cancellationNotice: "How far ahead must a guest tell you to cancel?", noShowRelease: "Release the table for no-show after",
      lastLunch: "Last reservation (lunch)", lastDinner: "Last reservation (dinner)",
      cxNone: "No notice needed", cxSameDay: "Same day is fine", cx2h: "At least 2 h ahead", cx24h: "At least 24 h ahead",
      ...
      info: {
        ...
        lateTolerance: "How many minutes you hold a table for a guest who ARRIVES late before you can give it to someone else. E.g. 15 min → if they book for 21:00 and don't arrive, at 21:15 it becomes a no-show. This applies to guests who do NOT warn you. If the guest reports a delay, the bot shifts the reservation time accordingly (e.g. 21:30 + 30 min → 22:00).",
        ...
        noShowRelease: "Different from late tolerance: here the guest does NOT show up and does NOT warn you. How long you wait before releasing the table to someone else. If you don't specify it, the assistant won't invent a time.",
  ...
  de: {
    ...
    q4: {
      ...
      depositAmount: "Höhe der Anzahlung", depositAmountPlaceholder: "20€ pro Person / 50€ pro Tisch",
      lateTolerance: "Verspätungstoleranz", lateGrace: "Mehr Spielraum, wenn der Gast vorher Bescheid gibt?",
      cancellationNotice: "Wie früh muss ein Gast eine Stornierung melden?", noShowRelease: "Tisch bei No-Show freigeben nach",
      lastLunch: "Letzte Reservierung (Mittag)", lastDinner: "Letzte Reservierung (Abend)",
      cxNone: "Keine Vorankündigung nötig", cxSameDay: "Am selben Tag genügt", cx2h: "Mindestens 2 Std. vorher", cx24h: "Mindestens 24 Std. vorher",
      ...
      info: {
        ...
        lateTolerance: "Wie viele Minuten ihr einen Tisch für einen Gast haltet, der zu spät KOMMT, bevor ihr ihn anderweitig vergeben könnt. Z. B. 15 Min. → bucht er für 21:00 und kommt nicht, wird daraus um 21:15 ein No-Show. Das gilt für Gäste, die NICHT Bescheid geben. Meldet der Gast die Verspätung, verschiebt der Bot die Reservierungszeit entsprechend (z. B. 21:30 + 30 Min. → 22:00).",
        ...
        noShowRelease: "Anders als die Verspätungstoleranz: Hier erscheint der Gast NICHT und gibt NICHT Bescheid. Wie lange ihr wartet, bevor ihr den Tisch freigebt. Wenn du es nicht angibst, erfindet der Assistent keine Zeit.",
