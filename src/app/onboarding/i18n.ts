  ...
  es: {
    ...
    q4: {
      ...
      info: {
        ...
        lateTolerance: "Cuántos minutos guardáis la mesa a un cliente que LLEGA tarde antes de poder dársela a otro. Ej.: 15 min → si reserva a las 21:00 y no llega, a las 21:15 la mesa puede reasignarse. No envía recordatorios; solo gestiona la espera.",
  ...
  it: {
    ...
    q4: {
      ...
      info: {
        ...
        lateTolerance: "Quanti minuti tenete il tavolo a un cliente che ARRIVA in ritardo prima di poterlo dare a qualcun altro. Es.: 15 min → se prenota alle 21:00 e non arriva, alle 21:15 il tavolo può essere riassegnato. Non manda promemoria; gestisce solo l'attesa.",
  ...
  en: {
    ...
    q4: {
      ...
      info: {
        ...
        lateTolerance: "How many minutes you hold a table for a guest who ARRIVES late before you can give it to someone else. E.g. 15 min → if they book for 21:00 and don't arrive, at 21:15 the table can be reassigned. It sends no reminders; it only manages the wait.",
  ...
  de: {
    ...
    q4: {
      ...
      info: {
        ...
        lateTolerance: "Wie viele Minuten ihr einen Tisch für einen Gast haltet, der zu spät KOMMT, bevor ihr ihn anderweitig vergeben könnt. Z. B. 15 Min. → bucht er für 21:00 und kommt nicht, kann der Tisch um 21:15 neu vergeben werden. Es werden keine Erinnerungen gesendet; es regelt nur die Wartezeit.",
